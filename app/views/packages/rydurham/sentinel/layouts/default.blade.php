	        ...
	        <div class="collapse navbar-collapse">
	          <ul class="nav navbar-nav">
				@if (Sentry::check() && Sentry::getUser()->hasAccess('admin'))
					...
					<li {{ (Request::is('retainers*') ? 'class="active"' : '') }}><a href="{{ URL::action('RetainersController@index') }}">Retainers</a></li>
					<li {{ (Request::is('contracts*') ? 'class="active"' : '') }}><a href="{{ URL::action('ContractsController@index') }}">Contracts</a></li>
				@endif
	          </ul>
